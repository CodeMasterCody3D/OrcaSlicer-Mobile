...
{
    // The OrcaSlicer admesh stl_open() no longer takes a progress callback or custom header
    // length; those SliceBeam extensions are dropped (STL load progress is no longer reported).
    (void) stlFn;
